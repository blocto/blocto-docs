...
Get encrypted user id from [web.js (EVM-based)](web3-provider-integration-ethereum-bsc-polygon-avalanche.md) or [web.js (Solana)](broken-reference). The user id is encrypted by AES (CBC).
